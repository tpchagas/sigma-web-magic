        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <a href="tel:1151995833" className="flex items-center text-sigma-muted hover:text-sigma-neon transition-colors">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 rounded-full bg-sigma-light flex items-center justify-center text-white hover:bg-sigma-neon hover:text-sigma-dark transition-all duration-300">
